...
import com.appsdeveloperblog.photoapp.api.albums.data.UserServiceClient;
...
public class AlbumsServiceImpl implements AlbumsService {
    ...
    @Autowired
    public AlbumsServiceImpl(UserServiceClient userServiceClient) {
    ...
    public ResponseEntity<UserResponseModel> getUser(String userId) {
        ResponseEntity<UserResponseModel> user = userServiceClient.getUser(userId);
        return user;
    }
}
